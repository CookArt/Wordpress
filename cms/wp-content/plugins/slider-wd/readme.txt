...
This free slider plugin can be used for creating  Image slider, video slider (specifically vimeo slider, youtube slider, HTML5 slider), post slider, photo slider / gallery slider and carousel slider are the most commonly used applications of the best slider plugin, but those can be expanded to meet the needs.    
